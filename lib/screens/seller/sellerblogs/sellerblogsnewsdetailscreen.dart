...
class SellerBlogsNewsDetailsScreen extends StatefulWidget {
  const SellerBlogsNewsDetailsScreen({super.key});

  @override
  State<SellerBlogsNewsDetailsScreen> createState() =>
      _SellerBlogsNewsDetailsScreenState();
}

class _SellerBlogsNewsDetailsScreenState
    extends State<SellerBlogsNewsDetailsScreen> {
